...
- You can restrict traffic to multiple virtual networks in multiple subscriptions with a single Azure firewall. This is a difference between Firewall and NSG. 
